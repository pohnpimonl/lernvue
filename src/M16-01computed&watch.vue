  ...
  <div>
    ...
    <div>
      ...
      <div v-if="tab === 3">
        ...
        <div>
            <h2>Methods Total{{ total() }}Baht</h2>
            <h2>Computed Total{{ ctotal }}Baht</h2>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  watch:{
      ctotal(newValue, oldValue){
          if(newValue>=1000 && oldValue<1000){
              alert('>=1000')
          } else if(newValue>=400 && oldValue<400){
              alert('>=400')
          } else if(newValue>=200 && oldValue<200){
              alert('>=200')
          }
      }
  },
